  ...
  return (
    <div className="max-w-4xl">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <div>
          <h3 className="text-2xl font-bold text-gray-900">Doubt Forum</h3>
        ...
        <button
          ...
          className="inline-flex items-center justify-center gap-2 px-4 py-2.5 bg-indigo-600 text-white text-sm font-medium rounded-xl hover:bg-indigo-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed shadow-sm shadow-indigo-600/20"
        >
      ...
      <div className="flex flex-col sm:flex-row sm:items-center gap-4 mb-6">
        <div className="relative">
          ...
          <select
            ...
            className="pl-9 pr-8 py-2.5 bg-white border border-gray-200 rounded-xl text-sm font-medium text-gray-700 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none appearance-none disabled:opacity-50"
          >
            {batches.map((batch) => (
      ...
      {hasMore && !loading && (
        <div className="mt-6 text-center">
          <button
            ...
            className="inline-flex items-center gap-2 px-6 py-2.5 text-sm font-medium text-gray-700 bg-white border border-gray-200 rounded-xl hover:bg-gray-50 transition-colors disabled:opacity-50"
          >
...
function QuestionCard({
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
      <button
        onClick={onToggle}
        className="w-full text-left p-5 hover:bg-gray-50/60 transition-colors"
      >
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="mt-3 flex items-center gap-4 text-xs text-gray-400">
              <span className="font-medium text-gray-500">{question.author.name}</span>
      ...
      {expanded && (
        <div className="border-t border-gray-100 px-5 py-5 space-y-5">
          {question.imageUrl && (
            <div className="rounded-xl overflow-hidden bg-gray-50 border border-gray-100 max-h-96">
              <img
          ...
          <div>
            ...
            {!threadLoading && thread && thread.answers && thread.answers.length === 0 && (
              <p className="text-sm text-gray-400 italic">No answers yet. Be the first to reply.</p>
            )}
            ...
            <div className="flex justify-end">
              {question.isResolved ? (
                ...
                <button
                  ...
                  disabled={resolving}
                  className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-emerald-700 bg-emerald-50 border border-emerald-200 rounded-xl hover:bg-emerald-100 transition-colors disabled:opacity-50"
                >
  ...
  return (
    <div className="flex items-start gap-3">
      ...
      <div className="flex-1 bg-gray-50 rounded-xl rounded-tl-none px-4 py-3">
        ...
        {answer.imageUrl && (
          <div className="mt-3 rounded-lg overflow-hidden border border-gray-200 max-h-72">
            <img
              src={answer.imageUrl}
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-3">
      ...
      {previewUrl && (
        <div className="relative inline-block">
          ...
          <button
            ...
            className="absolute -top-2 -right-2 bg-white rounded-full shadow border border-gray-200 p-0.5 text-gray-500 hover:text-gray-700"
      ...
      <div className="flex items-center justify-between gap-3">
        <label className="inline-flex items-center gap-1.5 text-sm font-medium text-gray-600 hover:text-gray-900 cursor-pointer">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-white bg-indigo-600 rounded-xl hover:bg-indigo-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
        >
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 p-4">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-lg max-h-[90vh] overflow-y-auto">
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
          <h4 className="text-lg font-semibold text-gray-900">Ask a Doubt</h4>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
            ...
            {previewUrl ? (
              <div className="relative inline-block">
                <img
                  ...
                  className="h-28 w-40 object-cover rounded-xl border border-gray-200"
                />
                <button
                  type="button"
                  onClick={() => {
              ...
              <label className="flex flex-col items-center justify-center gap-2 border-2 border-dashed border-gray-200 rounded-xl px-4 py-6 text-gray-500 hover:border-indigo-300 hover:text-indigo-600 cursor-pointer transition-colors">
          ...
          <div className="flex justify-end gap-3 pt-2">
            ...
            <button
              type="submit"
              disabled={submitting}
              className="inline-flex items-center gap-2 px-5 py-2 text-sm font-medium text-white bg-indigo-600 rounded-xl hover:bg-indigo-700 transition-colors disabled:opacity-50"
            >
...
function Avatar({ name, size = 'md' }: { name: string; size?: 'sm' | 'md' }) {
  ...
  return (
    <div
      className={`${size === 'sm' ? 'w-8 h-8 text-xs' : 'w-10 h-10 text-sm'} rounded-full bg-indigo-100 flex items-center justify-center font-semibold text-indigo-600 shrink-0`}
    >
      {initials}
    </div>
  );
